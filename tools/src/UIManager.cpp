...
UIManager::UIManager(GlobalParam &gp, int max_row)
{
    ...
    param_list = {
      ...
      {&gp.r_yaw_static, "r_yaw_static", '*', 1.1, 2},
      {&gp.r_yaw_static_vyaw_thresh, "r_yaw_static_vyaw_thresh", '*', 1.1, 2},
      ...
      {&gp.r_yaw_obs, "r_yaw_obs", '*', 1.1, 2},
      {&gp.r_pitch_obs, "r_pitch_obs", '*', 1.1, 2},
      {&gp.r_dist, "r_dist", '*', 1.1, 2},
      {&gp.r_dist_coeff, "r_dist_coeff", '*', 1.1, 2},
      {&gp.r_dist_base, "r_dist_base", '*', 1.1, 2},
    };
